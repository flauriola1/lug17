...
public class Eccezione1 {
	public static void main(String[] args){
		...
		try { // try: provo a svolgere il codice nelle parentesi graffe
			...
			numeri[7] = 10; // provoco l'eccezione
			System.out.println("Questo non verrà stampato"); // perchè Java ha urgenza di cercare un catch nell'eccezione, quindi "salta" a rigo 13
		...
		finally { // il codice nel finally viene svolto comunque, se l'eccezione è ben gestita oppure non si manifesta
